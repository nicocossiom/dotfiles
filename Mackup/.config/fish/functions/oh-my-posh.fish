...
function _render_tooltip
  ...
  set omp_tooltip_prompt (/opt/homebrew/bin/oh-my-posh print tooltip --config $POSH_THEME --shell fish --status $omp_status_cache --shell-version $FISH_VERSION --command $omp_tooltip_command)
